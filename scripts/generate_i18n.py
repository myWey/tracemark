...
translations = {
    ...
    "步骤文字": {"en": "Step Text", "zh-Hans": "步骤文字", "zh-Hant": "步驟文字", "ja": "ステップテキスト", "ko": "단계 텍스트"},
    "框选文字": {"en": "Box Text", "zh-Hans": "框选文字", "zh-Hant": "框選文字", "ja": "枠選びテキスト", "ko": "박스 선택 텍스트"},
    "序号": {"en": "Number", "zh-Hans": "序号", "zh-Hant": "序號", "ja": "番号", "ko": "번호"},
