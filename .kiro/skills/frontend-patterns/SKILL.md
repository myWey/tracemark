...
description: Frontend layered architecture patterns (tokens/primitives/composites/features/pages). Load when building or refactoring UI components in packages/ui-* or apps/*, deciding which layer something belongs in, or untangling layer violations.
---
