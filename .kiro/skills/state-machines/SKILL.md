---
name: state-machines
description: UI state machine design (XState-style). Load when designing complex interaction flows, multi-step wizards, async operations with cancellation/retry, or when a feature has more than ~3 mutually exclusive view states.
---
