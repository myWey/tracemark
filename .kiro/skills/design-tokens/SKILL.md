---
name: design-tokens
description: Design tokens (DTCG format). Load when editing shared/tokens/*, proposing new semantic tokens, refactoring inline color/spacing/typography values, or auditing visual consistency.
---
